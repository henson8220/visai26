          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div className="relative p-8 rounded-2xl border border-[#a88d66] bg-[#e6d3b1] shadow-[0_10px_28px_rgba(80,60,30,0.14)] hover:-translate-y-2 hover:border-[#8b6b4f] transition-all duration-500 overflow-hidden">
              ...
              <div className="pr-24">
                ...
                <p className="text-[#5a4636] leading-relaxed">
                  VISAI is a space where young hearts rise higher in their walk with God.
                  Through worship, Word, and fellowship, we are strengthened to soar
                  above challenges and grow deeper in faith.
                </p>
              </div>
            </div>
            ...
            <div className="relative p-8 rounded-2xl border border-[#a88d66] bg-[#e6d3b1] shadow-[0_10px_28px_rgba(80,60,30,0.14)] hover:-translate-y-2 hover:border-[#8b6b4f] transition-all duration-500 overflow-hidden">
              ...
              <div className="pr-24">
                ...
                <p className="text-[#5a4636] leading-relaxed">
                  VISAI calls every young person to run their race with clarity and purpose.
                  Using the gifts God has given, we move forward boldly — carrying His
                  message into every space we step into.
                </p>
              </div>
            </div>
            ...
            <div className="relative p-8 rounded-2xl border border-[#a88d66] bg-[#e6d3b1] shadow-[0_10px_28px_rgba(80,60,30,0.14)] hover:-translate-y-2 hover:border-[#8b6b4f] transition-all duration-500 overflow-hidden">
              ...
              <div className="pr-24">
                ...
                <p className="text-[#5a4636] leading-relaxed">
                  Beyond the event, VISAI encourages a steady and faithful walk with God.
                  Even in ordinary moments, we live out His Word daily — strong, grounded,
                  and unwavering.
                </p>
              </div>
            </div>
