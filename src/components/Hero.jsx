...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      ref={heroRef}
      className="pt-20 relative min-h-screen flex items-center justify-center text-center px-6 bg-[#e8dcc3] text-[#2f241f] overflow-hidden"
    >
  ...
  Delivery Is Live
          ...
          <div className="flex gap-4 justify-center flex-row">
            <a
              ...
              className="px-6 text-sm py-3 bg-yellow-400 text-black rounded-full font-semibold hover:scale-105 transition"
            >
              Register
            </a>
            <a
